...
import { Sidebar_DataA_Admin } from "@/_mock/data";
    ...
    >
      <div className="w-full px-4 py-9 h-full flex flex-col justify-between ">
          ...
          {Sidebar_DataA_Admin.map((item, idx) => {
            return (
              <button
                ...
                className={clsxm(
                  "pl-5 py-4  w-full ",
                  location === item.routes && "bg-black-800 rounded-[9px] "
                )}
              >
        ...
        <div>
          ...
          <button className="flex items-center justify-center mt-12 rounded-[8px] gap-5 bg-red-400 w-full p-2 ">
