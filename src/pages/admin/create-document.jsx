...
export const validationSchemaDocument = yup.object({
  agreement_purpose: yup.string(),
  contribution_payment: yup.string(),
  contribution_payment1: yup.string(),
  management_administration: yup.string(),
  management_administration1: yup.string(),
  profit_distribution: yup.string(),
  profit_distribution1: yup.string(),
  duration_termination: yup.string(),
  duration_termination1: yup.string(),
  responsibility_risks: yup.string(),
  responsibility_risks1: yup.string(),
  data_protection: yup.string(),
  data_protection1: yup.string(),
  governing_law: yup.string(),
  governing_law1: yup.string(),
  acceptance_signature: yup.string(),
  acceptance_signature1: yup.string(),
});
