      ...
      <div className='relative mx-auto max-w-7xl text-black-100 dark:text-white'>
        <div className='grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center'>
          ...
          <div className='space-y-6'>
            ...
            {/* Tarjeta de estadísticas con diseño de alto contraste */}
            <div className='bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 shadow-xl border-2 border-blue-200 dark:border-gray-600'>
              {/* Header con icono */}
              ...
              {/* Estadística principal con diseño destacado */}
              <div className='bg-white dark:bg-gray-800 rounded-xl p-4 mb-4 border border-gray-200 dark:border-gray-600'>
