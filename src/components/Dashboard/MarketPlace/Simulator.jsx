...
export default function Simulator() {
  ...
  return (
    <div className="w-full mt-6  ">
      <div className="border border-base-800 rounded-[8px] p-5 w-full ">
        <p className="text-20 sm:text-24 font-bold text-center ">Simulator</p>
        <div>
          <p className="text-18 sm:text-20 font-medium font-ubuntu ">Exchange Rate=</p>
          <p className="sm:text-18 font-ubuntu text-center my-5 ">
            “1$= X currency(4000 Copan's)”
          </p>
          <p className=" font-medium font-ubuntu ">
            How many tokens would you buy.
          </p>
        </div>
        ...
        <div className="mt-10 ">
          <p className=" font-medium font-ubuntu  ">
            How many years you want to invest.
          </p>
