      ...
      <div className='mx-auto grid max-w-7xl gap-16 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.15fr)] lg:items-start text-black-100 dark:text-white'>
        <div className='space-y-8'>
          <div className='space-y-4'>
            ...
            <Badge 
              variant="outline" 
              className='bg-yellow/15 text-yellow/80 dark:bg-yellow/10 backdrop-blur-sm animate-fade-in'
            >
          ...
          {/* Cards de características mejoradas con Shadcn/UI */}
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
            {FEATURE_SUMMARY.map((item, index) => (
              <Card
                key={item.id}
                className='group relative overflow-hidden rounded-[24px] border-gray-200/60 bg-white shadow-[0_30px_80px_-65px_rgba(15,23,42,0.35)] transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-[0_40px_100px_-60px_rgba(15,23,42,0.45)] dark:border-gray-700/60 dark:bg-black-900/60 animate-scale-in'
          ...
          {/* Botón CTA mejorado con Shadcn/UI */}
          <Button
