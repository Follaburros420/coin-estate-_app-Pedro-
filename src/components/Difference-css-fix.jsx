...
function Difference() {
  ...
  return (
    <>
      {/* CSS personalizado para garantizar visibilidad */}
      <style jsx>{`
        .community-insights-card {
          color: #111827 !important; /* gray-900 para modo claro */
        }
        
        .dark .community-insights-card {
          color: #ffffff !important; /* blanco para modo oscuro */
        }
        
        .community-insights-badge {
          color: #6B7280 !important; /* gray-500 para modo claro */
        }
        
        .dark .community-insights-badge {
          color: #D1D5DB !important; /* gray-300 para modo oscuro */
        }
        
        .community-insights-description {
          color: #6B7280 !important; /* gray-500 para modo claro */
        }
        
        .dark .community-insights-description {
          color: #D1D5DB !important; /* gray-300 para modo oscuro */
        }
      `}</style>
        ...
        <div className='relative mx-auto max-w-7xl text-black-100 dark:text-white'>
          <div className='grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center'>
            <div className='relative overflow-hidden rounded-[36px] border border-gray-200/60 bg-white shadow-[0_45px_120px_-70px_rgba(15,23,42,0.25)] dark:border-white/15 dark:bg-[#11121f] dark:shadow-[0_60px_140px_-80px_rgba(0,0,0,0.8)] backdrop-blur'>
              ...
              />
              {/* Card de estadísticas con CSS personalizado */}
              <div className='absolute inset-x-5 bottom-5 rounded-[24px] border border-gray-200/60 bg-white p-5 shadow-[0_30px_70px_-60px_rgba(15,23,42,0.35)] backdrop-blur dark:border-white/15 dark:bg-[#11121f]/90 dark:shadow-none'>
                <p className='community-insights-badge text-12 font-semibold uppercase tracking-[0.35em]'>
                  Community insights
                </p>
                <p className='community-insights-card mt-2 text-20 font-bold'>
                  +6.2% rentabilidad promedio anual
                </p>
                <p className='community-insights-description mt-1 text-12'>
                  Resultados históricos de los proyectos tokenizados en los últimos 18 meses.
                </p>
              </div>
            </div>
            <div className='space-y-6'>
              <span className='inline-flex items-center gap-2 rounded-full border border-yellow/20 bg-yellow/10 px-4 py-1 text-12 font-semibold uppercase tracking-[0.24em] text-yellow/80 dark:border-white/25 dark:bg-white/5 dark:text-white/70'>
