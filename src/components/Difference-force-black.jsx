...
function Difference() {
  ...
  return (
    <>
      {/* CSS personalizado para forzar texto negro */}
      <style jsx>{`
        ...
        .community-insights-card * {
          color: #111827 !important; /* fuerza negro en todos los elementos hijos */
        }
        ...
        <div className='relative mx-auto max-w-7xl text-black-100 dark:text-white'>
          <div className='grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center'>
            <div className='relative overflow-hidden rounded-[36px] border border-gray-200/60 bg-white shadow-[0_45px_120px_-70px_rgba(15,23,42,0.25)] dark:border-white/15 dark:bg-[#11121f] dark:shadow-[0_60px_140px_-80px_rgba(0,0,0,0.8)]'>
              ...
              <div 
                className='community-insights-container absolute inset-x-5 bottom-5 rounded-[24px] border border-gray-200/60 p-5 shadow-[0_30px_70px_-60px_rgba(15,23,42,0.35)] dark:border-white/15 dark:shadow-none'
                style={{ zIndex: 10 }}
              >
                <p className='community-insights-badge text-xs font-semibold uppercase tracking-[0.35em]'>
                  Community insights
                </p>
                <p className='community-insights-card mt-2 text-xl font-bold'>
                  +6.2% rentabilidad promedio anual
                </p>
                <p className='community-insights-description mt-1 text-xs'>
