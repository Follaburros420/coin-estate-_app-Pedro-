          ...
          return (
            <SwiperSlide key={`${items.id}___${idx}`}>
              <div
                ...
                className="max-w-[371px] mx-auto lg:mx-0 mt-4 lg:mt-0 min-h-[450px] md:min-h-[500px] lg:min-h-[450px] xl:min-h-[400px] bg-white border border-yellow p-4"
              >
                <div className="flex gap-4 items-center">
                  <StyledImage className={"w-20 h-20"} src={items.img} alt="" />
                  <div>
                ...
                <p className="mt-6 text-14 text-grey-100 sm:text-16 font-inter font-regular">
                  {items.about}
                </p>
              </div>
            </SwiperSlide>
