    ...
    <section className='relative overflow-hidden bg-gradient-to-br from-black-500 via-black-600 to-black-800 text-white dark:from-black-900 dark:via-black-800 dark:to-black-900'>
      ...
      <div className='relative mx-auto flex max-w-7xl flex-col items-center gap-16 px-6 pb-24 pt-32 lg:flex-row lg:items-start lg:gap-20'>
        <div className='w-full max-w-xl text-center lg:text-left'>
          <span className='inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-1 text-11 font-semibold uppercase tracking-[0.25em] text-white/70 backdrop-blur-sm animate-fade-in'>
          ...
          <div className='mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-start sm:gap-4 animate-slide-up' style={{animationDelay: '0.6s'}}>
            <button
              ...
              className='group w-full max-w-[220px] rounded-full bg-gradient-to-r from-yellow to-yellow-300 px-8 py-3 text-14 font-semibold text-black-100 shadow-[0_15px_45px_-20px_rgba(255,200,44,0.7)] transition-all duration-300 hover:translate-y-[-2px] hover:shadow-[0_20px_60px_-25px_rgba(255,200,44,0.8)] hover:scale-105 sm:w-auto'
            >
              <span className='relative z-10'>Regístrate ahora</span>
              <div className='absolute inset-0 rounded-full bg-gradient-to-r from-yellow-300 to-yellow opacity-0 transition-opacity duration-300 group-hover:opacity-100' />
            </button>
            <button
              onClick={() => router.push('/working')}
              className='group w-full max-w-[220px] rounded-full border border-white/40 px-8 py-3 text-14 font-semibold text-white transition-all duration-300 hover:border-yellow hover:text-yellow hover:bg-white/5 hover:scale-105 sm:w-auto'
            >
              Conoce más
            </button>
          </div>
          <div className='mt-10 grid w-full gap-4 sm:grid-cols-3 animate-slide-up' style={{animationDelay: '0.8s'}}>
            {HERO_STATS.map((stat, index) => (
              <div
                key={stat.id}
                className='group relative overflow-hidden rounded-[26px] border border-white/10 bg-white/5 px-4 py-5 text-left shadow-[0_25px_50px_-30px_rgba(8,8,8,0.9)] backdrop-blur transition-all duration-300 hover:scale-105 hover:border-yellow/30 hover:bg-white/10'
        ...
        <div className='relative w-full max-w-xl animate-slide-up' style={{animationDelay: '1.2s'}}>
          ...
          <div className='group relative overflow-hidden rounded-[32px] border border-white/10 bg-white/10 shadow-[0_45px_120px_-40px_rgba(10,10,10,0.9)] backdrop-blur-xl transition-all duration-500 hover:scale-105 hover:shadow-[0_60px_150px_-50px_rgba(10,10,10,0.95)]'>
