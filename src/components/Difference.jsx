      ...
      <div className='relative mx-auto max-w-7xl text-black-100 dark:text-white'>
        <div className='grid gap-12 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center'>
          <div className='relative overflow-hidden rounded-[36px] border border-gray-200/60 bg-white shadow-[0_45px_120px_-70px_rgba(15,23,42,0.25)] dark:border-white/15 dark:bg-[#11121f] dark:shadow-[0_60px_140px_-80px_rgba(0,0,0,0.8)] backdrop-blur'>
            ...
            />
            <div className='absolute inset-x-5 bottom-5 rounded-[24px] border border-gray-200/60 bg-white p-5 text-black-100 shadow-[0_30px_70px_-60px_rgba(15,23,42,0.35)] backdrop-blur dark:border-white/15 dark:bg-[#11121f]/90 dark:text-white dark:shadow-none'>
              <p className='text-12 font-semibold uppercase tracking-[0.35em] text-black-100/60 dark:text-white/60'>Community insights</p>
              <p className='mt-2 text-20 font-bold'>+6.2% rentabilidad promedio anual</p>
              <p className='mt-1 text-12 text-black-100/70 dark:text-white/70'>Resultados históricos de los proyectos tokenizados en los últimos 18 meses.</p>
            </div>
          </div>
