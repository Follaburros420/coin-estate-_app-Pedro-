    ...
    <section className='relative -mt-12 overflow-hidden px-6 pb-20'>
      ...
      <div className='mx-auto max-w-7xl'>
        <div className='mx-auto max-w-2xl text-center space-y-4'>
          <span className='inline-flex items-center justify-center gap-2 rounded-full border border-yellow/40 bg-yellow/10 px-4 py-1 text-12 font-semibold uppercase tracking-[0.24em] text-yellow/80 dark:border-yellow/20 dark:bg-yellow/10 backdrop-blur-sm animate-fade-in'>
            Invertir es simple
          </span>
        ...
        <div className='mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
          {Tokens_Cards_Data.map((items, idx) => (
            <article
              ...
              className='group relative overflow-hidden rounded-[28px] border border-gray-200/60 bg-white p-7 shadow-[0_35px_90px_-60px_rgba(15,23,42,0.35)] transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-[0_50px_120px_-50px_rgba(15,23,42,0.5)] dark:border-white/10 dark:bg-[#141a2e] dark:shadow-[0_45px_110px_-70px_rgba(0,0,0,0.65)] animate-scale-in'
