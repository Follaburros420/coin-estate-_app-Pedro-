        ...
        <div className="w-full max-w-[1161px] mx-auto">
          <div className="font-inter text-center sm:text-start ">
            ...
            <p className="text-gray font-medium mt-6 ">
              Al invertir en proyectos de alto nivel, como lo hacen los grandes
              inversionistas, te conviertes tú tamibén en un gran inversor. Por
              eso es fundamental dominar ciertos conceptos clave. Hemos
              preparado este glosario que esperamos te de las herramientas
              necesarias para tomar decisiones informadas y estratégicas en cada
              paso del camino.
            </p>
          </div>
            ...
            {Glossary_Content_Data.map((item, idx) => {
              return (
                ...
                >
                  ...
                  <p className="text-gray text-14 text-wrap w-full ">
                    {item.desc}
                  </p>
                </div>
              );
